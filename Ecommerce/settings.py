JAZZMIN_SETTINGS = {
    ...
    "site_title": "The SADAF SHOP Admin",

    # Title on the brand, and login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "SADAF SHOP",

    # Welcome text on the login screen
    "welcome_sign": "Welcome to the SADAF SHOP admin panel! :)",

    # Copyright on the footer
    "copyright": "The SADAF SHOP",
...
SECRET_KEY = 'django-insecure-n*n9mer&yk%v)zta50cf@d9gv1%gtv*$@@k)p4(+l@-0h*$rk3'
